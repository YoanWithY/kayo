...
class BasicMesh {
    ...
    static appendUVSphere(mo: MeshObject, radius: number = 1, segments: number = 32, rings = 16) {
        rings--;
        const mesh = new Mesh();
    ...
    static appendZFunktion(mo: MeshObject, fun: (u: number, v: number) => number, uStart: number = -8, uEnd: number = 8, vStart: number = -8, vEnd: number = 8, uRes: number = 128, vRes: number = 128, nan: number = 0) {
        const mesh = new Mesh();
    ...
    static appendTorus(mo: MeshObject, ri: number = 1, ro: number = 0.5, outerRes: number = 32, innerRes: number = 16) {
    ...
    static appendCone(mo: MeshObject, br: number, height: number, res: number) {
        const mesh = new Mesh;
        for (let i = 0; i < res; i++) {
