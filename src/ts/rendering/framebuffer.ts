...
export default class FrameBuffer {
    ...
    static FSQShader = new ShaderProgram(FrameBuffer.FSQVertexShaderCode, FrameBuffer.FSQFragmentShader);
    static BlitOutlineShader = new ShaderProgram(FrameBuffer.FSQVertexShaderCode, FrameBuffer.blitOutlineFragmentShaderCode, ["acti"]);
