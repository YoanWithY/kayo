...
import { DropDown, DropDownItem } from "../../../UI-Lib/components/DropDown";
...
export class PTPChatPane extends HTMLElement {
	...
	private _win!: Window;
	public static createUIElement(win: Window, kayo: KayoInstance): PTPChatPane {
		...
		const copyListener = () => {
			...
			navigator.clipboard.writeText(p._kayo.project.projectUUID).then(notifyCopyCallback);
		};
