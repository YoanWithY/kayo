...
import { Viewport2D } from "../../../KayoInstance/ts/Viewport/Viewport";
import { FCurveSegment, KayoNumber } from "../../../KayoInstance/c/KayoCorePP";
import { AnimationTool, animationTools, ViewTool } from "./AnimationTools";
import { clamp } from "../../../KayoInstance/ts/math/math";
import { isNoPointerButtonDown, isPointerButtonDown, PointerButtons } from "../../../../UI-Lib/UIUtils";
...
export class AnimationPane extends HTMLElement implements Viewport2D {
	...
	public static createUIElement(win: Window, kayo: KayoInstance): AnimationPane {
