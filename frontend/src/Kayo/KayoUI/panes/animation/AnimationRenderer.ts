import { FCurveSegment } from "../../../KayoInstance/c/KayoCorePP";
import { KayoInstance } from "../../../KayoInstance/ts/KayoInstance";
import { Renderer } from "../../../KayoInstance/ts/Renderer";
import { linearStep } from "../../../KayoInstance/ts/math/math";
import { getWindowZoom } from "../../../KayoInstance/ts/Utils";
import { AnimationPane } from "./AnimationPane";
import { UI2DViewport } from "../../../KayoInstance/ts/Viewport/UIViewport";
...
export class AnimationRenderer implements Renderer {
	public registeredViewports: Set<UI2DViewport> = new Set();
	...
	private _renderBackgroundGrid(viewport: UI2DViewport) {
	...
	public registerViewport(viewport: UI2DViewport): void {
		this.registeredViewports.add(viewport);
	}
	public unregisterViewport(viewport: UI2DViewport): void {
		this.registeredViewports.delete(viewport);
	}

	public get rendererKey() {
		return "__kayo__animation";
	}
}
