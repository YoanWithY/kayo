...
export class PerformancePanel extends HTMLElement implements Viewport {
	...
	public static createUIElement(win: Window, kayo: KayoInstance): PerformancePanel {
		const p = win.document.createElement(this.getDomClass()) as PerformancePanel;
		p._win = win;
		p._kayo = kayo;
